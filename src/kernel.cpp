...
static std::map<int, unsigned int> mapStakeModifierCheckpoints =
    ...
    (     0, 0xfd11f4e7u )//u means unsigned
   // (5000, 0x2339251au )
   // (10000, 0xd6182618u )
...
bool CheckStakeKernelHash(unsigned int nBits, const CBlock& blockFrom, unsigned int nTxPrevOffset, const CTransaction& txPrev, const COutPoint& prevout, unsigned int nTimeTx, uint256& hashProofOfStake, bool fPrintProofOfStake)
{
    ...
    CBigNum bnCoinDayWeight = CBigNum(nValueIn) * nTimeWeight / COIN / (24 * 60 * 60);
	 ...
	 //printf(">>>\n\n>>>CheckStakeKernelHash: nTimeWeight = %"PRI64d"\n", nTimeWeight);
	// printf(">>>CheckStakeKernelHash: nTimeWeight = %"PRI64d",nStakeMinAge=%d ,nStakeMaxAge=%d \n", nTimeWeight,nStakeMinAge,nStakeMaxAge);
    // Calculate hash
    CDataStream ss(SER_GETHASH, 0);
