...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(agoldcoinUnits::BTC)
    {
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = agoldcoinUnits::formatWithUnit(unit, amount, true);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(qint64 balance, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance)
{
    ...
    //ui->labelStake->setText(agoldcoinUnits::formatWithUnit(unit, stake));
    ui->labelUnconfirmed->setText(agoldcoinUnits::formatWithUnit(unit, unconfirmedBalance));
    ui->labelImmature->setText(agoldcoinUnits::formatWithUnit(unit, immatureBalance));
