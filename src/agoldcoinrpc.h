...
#ifndef _agoldcoinRPC_H_
#define _agoldcoinRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // agoldcoin is not connected
...
/**
 * agoldcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
